...
<h5 id="atte_list">Attendent List On &raquo; <i class='sms_erro'><?php echo date('Y-m-d'); ?></i></h5>
<div class="row">

    <div class="col-lg-12">
        <!-- Advanced Tables -->
        <div id="tbl_atte" class="panel panel-default">
    ...
    '2' => 'No Permission'
        ...
        <input type="submit" name="btn_submit" value="Save" class="btn btn-primary" id="save_atte"/>
        <?php 
       echo anchor("admin/attendant/",'Cancel',array('class'=>'btn btn-danger')) ?>
        </td>
    </tr>
                               <?php
                            echo form_close(); ?>
