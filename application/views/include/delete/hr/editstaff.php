...
<?php echo $staff->cur_address;?>
    ...
    echo form_dropdown('use_id', $fullname,$staff->sta_id, 'class="box"');
   ...
   ?>
    ...
    echo form_dropdown('txt_sal', $salaries,$staff->sta_id, 'class="box"');
    ...
    <tr>
        ...
        <td>:</td>
         <td>
            ...
            <?php
	$positions = $this->mod_staff->getPostion();
    foreach ($positions->result() as $row_pos){
        $fullnames[$row_pos->pos_id] = $row_pos->pos_title;
      
    }
    echo form_dropdown('pos_id', $fullnames,$staff->pos_id, 'class="box"');
