            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Projects Management<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                             <li>
                          <?php echo anchor('projects/records','Record Projects');?>
                        </li>
                        <li>
                          <?php echo anchor('projects/adds','Add Projects');?>
                        </li>
                        <li>
                            <?php echo anchor('projects/details','Detail Projects');?>
                        </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
